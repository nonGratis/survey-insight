"""Сторінка «Огляд форми» — інспекція структури обраної Google Form.

Раніше ця сторінка називалась «Аналіз», але насправді показує
**дескриптивну інформацію про форму** (питання, типи, варіанти,
к-сть відповідей у привʼязаному Sheet) — це інспекція форми, а не
аналіз даних. Реальний аналіз (розподіли, прогнози, репрезентативність)
переїздить у нову сторінку `analysis.py` з 5 вкладками.
"""
